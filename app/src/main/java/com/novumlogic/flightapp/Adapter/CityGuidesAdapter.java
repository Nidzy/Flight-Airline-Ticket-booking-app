...
public class CityGuidesAdapter extends RecyclerView.Adapter<CityGuidesAdapter.CardViewHolder> {
    ...
    public CityGuidesAdapter(Context mcontext, ArrayList<Destination> thalidetails) {
    ...
    @Override
    public CityGuidesAdapter.CardViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {

        Context context = viewGroup.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);

        View itemView = LayoutInflater.from(context).
                inflate(R.layout.row_cityguides, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(final CityGuidesAdapter.CardViewHolder cardViewHolder, final int i) {
        ...
        Picasso.with(getContext())
                ...
                .into(cardViewHolder.ivCityguide);
    ...
    public static class CardViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView ivCityguide;

        public CardViewHolder(View v) {
            super(v);

            ivCityguide = (ImageView) v.findViewById(R.id.ivCityguide);
